    ...
    <>
      ...
      <LayoutGroup>
        <motion.div
          ...
          className={`fixed top-5 left-5 z-[9999] border border-white/15 ${
            expanded
              ? "w-72 bg-[#1C1C1C]/95 backdrop-blur-md rounded-2xl shadow-xl p-5"
              : "bg-[#1C1C1C]/90 backdrop-blur rounded-full shadow-lg px-4 py-2.5 cursor-pointer hover:shadow-xl"
          }`}
          ...
          {!expanded ? (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  onClick={() => setExpanded(false)}
                  className="text-[#F5F5F5]/70 hover:text-[#F5F5F5] transition-colors text-lg leading-none cursor-pointer"
                  aria-label="close"
                >
                  &times;
                </button>
              ...
              <div className="mt-4 pt-3 border-t border-white/10">
                <div className="flex items-center justify-between mb-1.5">
                  <span className="text-xs text-[#F5F5F5]/70">{pct}% complete</span>
                </div>
                <Progress
                  size="sm"
                  value={pct}
